...
<head>
    ...
    <body>
        ...
        <!-- TITULO 1 CONTENEDOR CONTENIDO INICIO -->
            ...
            <div  class="contenedor_contenido_inicio" id="contenedor_contenido_inicio">
                
                <!-- TITULO 2 PARTE SUPERIOR CONTENIDO INICIO -->

                    <!-- parte superior contenido inicio -->
                    <div class="parte_superior_contenido_inicio" id="parte_superior_contenido_inicio">
                ...
                <!-- TITULO 6 PARTE INFERIOR CONTENIDO INICIO -->
                    ...
                    <div class="parte_inferior_contenido_inicio" id="parte_inferior_contenido_inicio">
